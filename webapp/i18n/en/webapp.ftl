...
data-for-demonstration = All data currently in the application is for demonstration purposes only. Feel free to play with and test the application and survey.
...
## Question One
question-one = 1. Add an experience. The app will ask you different questions related to your intersectionality.

question-one-survey = { $number  ->
    [0] 1. Add an experience related to your race, culture or ethnic identity.
    [1] 1. Add an experience related to your gender.
    [2] 1. Add an experience related to your sexuality.
    [3] 1. Add an experience related to your socio-economic background.
    [4] 1. Add an experience related to your languages known and familiarity.
    [5] 1. Add an experience related to your level of education.
...
question-one-placeholder = { $number  ->
    ...
    [2] E.g.: Heterosexual, homosexual, bisexual, gay, lesbian, asexual...
    [3] E.g.: Middle socio-economic upbringing, grew up poor, well off, in debt...
    [4] E.g.: Anglophone, francophone, polyglot, multi-lingual, non-official language speaker...
    [5] E.g.: High school education, college education, post-doctorate...
    [6] E.g.: Muslim, christian, personally spiritual, atheist...
    [7] E.g.: Fully abled, anxiety disorder, ADHD, visual disability, speech disorder...
    [8] E.g.: Extrovert, introvert, INTP, ISFP...
    [9] E.g.: Millenial, middle-aged, gen x, baby boomer...
    [10] E.g.: Highly stressed, poor work-life balance, lonely, overwhelmed...
...
legend = Legend
personal-experience-legend = Personal Experience
organizational-role-legend = Organizational Role
