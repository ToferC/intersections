...
question-one-placeholder = { $number  ->
    ...
    [2] E.g.: Middle-class upbringing, grew up poor, well off, in debt...
    [3] E.g.: High school education, college education, muslim, christian...
    [4] E.g.: Fully abled, anxiety disorder, ADHD, visual disability, speech disorder...
    [5] E.g.: Highly stressed, poor work-life balance, millenial, middle-aged, gen x, baby boomer...
    [6] E.g.: Parent, caregiver to my parents, married, divorced, single parent, without children...
    [7] E.g.: Employed, student, part-time worker, extrovert, interovert...
    *[other] Continue exploring: Body type, upbringing, appearance, mannerisms...
}
